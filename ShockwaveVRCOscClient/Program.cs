...
namespace ShockwaveVRChat
{
    static class Program
    {
        ...
        private static readonly string APP_NAME = "ShockwaveVRChatClient";
        private static readonly string APP_VERSION = "1.0.0";
        ...
        public static int StartClient()
        {
            ...
            bool isFirst;
            Mutex mutex = new Mutex(true, APP_NAME, out isFirst);
            if (!isFirst)
                return 0;
        ...
        {
            Console.WriteLine(Console.Title = $"{APP_NAME} v{APP_VERSION}");
